  ...
  try {
    ...
    switch (event.type) {
      case 'checkout.session.completed':
        ...
        // Get plan type from the price ID
        ...
        // Update or create user with correct plan and subscription info
        const userData = {
...
// Protected routes with authentication and subscription checks
...
async function startServer() {
  try {
    console.log("Initializing database and cleanup routines...");
